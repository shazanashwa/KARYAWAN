...
<style>
    ...
    .navbar-brand {
      display: flex;
      align-items: center;
      margin-right: 10px; /* Adjust the space between logos and the edge */
    }

    .navbar-brand img {
      max-height: 50px;
      width: auto;
      margin-right: 5px; /* Space between the two logos */
    }
    ...
    .additional-logos img {
      max-height: 50px;
      width: auto;
      margin-left: 0; /* Remove margin on the left to bring the logos closer */
    }
