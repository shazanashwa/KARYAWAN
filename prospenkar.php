                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                if ($row['foto'] != '') {
                                                    echo "<img src='images/{$row['foto']}' alt='Foto Karyawan' />";
                                                } else {
                                                    echo "No Image";
                                                }
                                                ?>
                                            ...
                                            <td>
                                                <a href="karyawan_edit.php?id_karyawan=<?php echo $row['id_karyawan']; ?>"><button class="btn btn-primary">Ubah</button></a> 
                                                <a href="hapus.php?id_karyawan=<?php echo $row['id_karyawan']; ?>"><button class="btn btn-danger" onclick="return confirm('Yakin ingin dihapus?');">Hapus</button></a>
                                            </td>
                                        </tr>
                                        <?php 
                                        }
